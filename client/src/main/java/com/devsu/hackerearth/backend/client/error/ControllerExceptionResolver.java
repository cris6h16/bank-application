package com.devsu.hackerearth.backend.client.error;
...
public class ControllerExceptionResolver {
    ...
    private HttpStatus getStatus(ApplicationErrors error) {
        final Map<ApplicationErrors, HttpStatus> handledErrors = Map.of(
                ApplicationErrors.CLIENT_NOT_FOUND, HttpStatus.NOT_FOUND,
                ApplicationErrors.CLIENT_DNI_ALREADY_EXISTS, HttpStatus.CONFLICT);
